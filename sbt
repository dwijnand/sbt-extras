...
declare -r sbt_launch_ivy_release_repo="https://dl.bintray.com/typesafe/ivy-releases"
declare -r sbt_launch_ivy_snapshot_repo="https://dl.bintray.com/sbt/ivy-snapshots"
declare -r sbt_launch_mvn_release_repo="https://dl.bintray.com/sbt/maven-releases"
declare -r sbt_launch_mvn_snapshot_repo="https://dl.bintray.com/sbt/maven-snapshots"
...
download_url () {
  ...
  mkdir -p "${jar%/*}" && {
    if command -v curl > /dev/null 2>&1; then
      curl --fail --silent --max-redirs 3 --location "$url" --output "$jar"
