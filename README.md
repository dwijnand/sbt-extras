...
-jar
$HOME/.sbt/launchers/0.13.6/sbt-launch.jar
"++ 2.10.4"
about
...
runner with the -x option.
  ...
  # sbt version (default: sbt.version from project/build.properties if present, otherwise 0.13.6)
  -sbt-force-latest         force the use of the latest release of sbt: 0.13.6
  -sbt-version  <version>   use the specified version of sbt (default: 0.13.6)
