...
```bash
brew install --HEAD dwijnand/formulas/sbtx
```
...
-Xss2m
-jar
$HOME/.sbt/launchers/1.4.6/sbt-launch.jar
"++ 2.12.12"
about

saving stty: [..]
[warn] No sbt.version set in project/build.properties, base directory: [..]
[info] Setting version to 2.12.12
...
[info] Set current project to [..] (in build file:[..])
[info] This is sbt 1.4.6
[info] The current project is ProjectRef(uri("file:[..]"), "[..]") [..]
[info] The current project is built against Scala 2.12.12
...
are not special.
  ...
  # sbt version (default: sbt.version from project/build.properties if present, otherwise 1.4.6)
  -sbt-version <version>  use the specified version of sbt (default: 1.4.6)
  -sbt-force-latest       force the use of the latest release of sbt: 1.4.6
  -sbt-dev                use the latest pre-release version of sbt: 1.4.6
