...
-Xss2m
-jar
$HOME/.sbt/launchers/1.5.6/sbt-launch.jar
"++ 2.12.15"
about
...
are not special.
  ...
  # sbt version (default: sbt.version from project/build.properties if present, otherwise 1.5.6)
  -sbt-version <version>  use the specified version of sbt (default: 1.5.6)
  -sbt-force-latest       force the use of the latest release of sbt: 1.5.6
