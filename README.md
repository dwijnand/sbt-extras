...
-Xss2m
-jar
$HOME/.sbt/launchers/1.8.1/sbt-launch.jar
"++ 2.12.17"
about

saving stty: [..]
[warn] No sbt.version set in project/build.properties, base directory: [..]
[info] Setting version to 2.12.17
...
are not special.
  ...
  # sbt version (default: sbt.version from project/build.properties if present, otherwise 1.8.1)
  -sbt-version <version>  use the specified version of sbt (default: 1.8.1)
  -sbt-force-latest       force the use of the latest release of sbt: 1.8.1
  -sbt-dev                use the latest pre-release version of sbt: 1.8.1
  ...
  # java version (default: java from PATH, currently java version "1.8.1_202-ea")
