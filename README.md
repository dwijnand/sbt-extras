...
-Xss2m
-jar
$HOME/.sbt/launchers/1.7.2/sbt-launch.jar
"++ 2.12.16"
about
...
[info] Setting Scala version to 2.12.16 on 1 projects.
[info] Reapplying settings...
[info] Set current project to [..] (in build file:[..])
[info] This is sbt 1.7.2
[info] The current project is ProjectRef(uri("file:[..]"), "[..]") [..]
[info] The current project is built against Scala 2.12.16
...
are not special.
  ...
  # sbt version (default: sbt.version from project/build.properties if present, otherwise 1.7.2)
  -sbt-version <version>  use the specified version of sbt (default: 1.7.2)
  -sbt-force-latest       force the use of the latest release of sbt: 1.7.2
  -sbt-dev                use the latest pre-release version of sbt: 1.7.2
