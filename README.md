...
-Xss2m
-jar
$HOME/.sbt/launchers/1.12.11/sbt-launch.jar
"++ 2.12.21"
about
...
are not special.
  ...
  # sbt version (default: sbt.version from project/build.properties if present, otherwise 1.12.11)
  -sbt-version <version>  use the specified version of sbt (default: 1.12.11)
  -sbt-force-latest       force the use of the latest release of sbt: 1.12.11
  -sbt-dev                use the latest pre-release version of sbt: 1.12.11
