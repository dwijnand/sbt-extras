...
are not special.
  ...
  # sbt version (default: sbt.version from project/build.properties if present, otherwise 1.10.5)
  -sbt-version <version>  use the specified version of sbt (default: 1.10.5)
