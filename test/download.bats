...
launcher_url () {
  case "$1" in
   ...
   0.10.*) echo "http://dl.bintray.com/typesafe/ivy-releases/org.scala-tools.sbt/sbt-launch/$1/sbt-launch.jar" ;;
        *) echo "http://dl.bintray.com/typesafe/ivy-releases/org.scala-sbt/sbt-launch/$1/sbt-launch.jar" ;;
  esac
}
...
Downloading sbt launcher for $sbt_13:
  From  http://dl.bintray.com/typesafe/ivy-releases/org.scala-sbt/sbt-launch/$sbt_13/sbt-launch.jar
...
Downloading sbt launcher for $sbt_release:
  From  http://dl.bintray.com/typesafe/ivy-releases/org.scala-sbt/sbt-launch/$sbt_release/sbt-launch.jar
...
Downloading sbt launcher for $sbt_dev:
  From  http://dl.bintray.com/typesafe/ivy-releases/org.scala-sbt/sbt-launch/$sbt_dev/sbt-launch.jar
...
@test "supports unix line endings (lf) in build.properties" {
  write_to_properties_and_fetch "sbt.version=0.13.8\n" "0.13.8"
}
